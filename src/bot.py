...
async def start_command(update: Update, context: CallbackContext) -> None:
    ...
    # Save players to CSV for persistence
    logger.info(player.savePlayersToCSV(players))
...
def main():
    ...
    # Load players on startup - try persistent.csv first, then fall back to pairings.csv
    logger.info(player.loadPlayersOnStartup(players))
